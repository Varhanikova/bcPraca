    ...
    <div class="col-md-8">
       ...
       <article >
            ...
            <ul>
                ...
                <li>Za najviac infekčnú sa považuje osoba s prítomnými klinickými príznakmi. Osoba je infekčná už pred nástupom prvých príznakov.</li>
        ...
        <article>
            ...
            <ul>
                <li>Umývajte si ruky často mydlom a vodou najmenej po dobu 20 sekúnd. Ak nie je k dispozícii mydlo a voda, treba použiť dezinfekčný prostriedok na ruky na báze alkoholu.</li>
                <li>Očí, nosa ani úst sa nedotýkajte neumytými rukami.</li>
                <li>Zakrývajte si nos a ústa pri kašľaní a kýchaní jednorazovou papierovou vreckovkou a následne ju zahoďte do koša.</li>
                <li>Vyhýbajte sa blízkemu kontaktu s ľuďmi, ktorí javia príznaky nádchy alebo chrípky.</li>
                <li>Ak ste chorý, kontaktujte svojho ošetrujúceho lekára, ktorý určí ďalší postup liečby, doma na lôžku sa z ochorenia liečte v samostatnej izbe.</li>
