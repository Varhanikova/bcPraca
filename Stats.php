...
<div class="container ">
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5">
            <a href="DenneTestovanie.php">
                <img src="pics/kadzodenne_stat.png" width="100%" height="100%">
            </a>
        </div>
    </div>
    ...
    <div class="row featurette my-md-5 pt-md-5 border-top">
        ...
        <div class="col-md-5 order-md-1">
            <a href="Kraje.php">
                <img src="pics/testo_kraje.png" width="100%" height="100%">
            </a>
        </div>
    </div>
    ...
    <div class="row featurette my-md-5 pt-md-5 border-top">
        ...
        <div class="col-md-5">
            <a href="Nemocnice.php">
                <img src="pics/nemocnice.png" width="100%" height="100%">
            </a>
        </div>
    </div>
    <hr class="featurette-divider ">
    ...
    <div class="row featurette my-md-5 pt-md-5 border-top">
        ...
        <div class="col-md-5 order-md-1">
            <a href="Umrtia.php">
                <img src="pics/úmrtia.png" width="100%" height="100%">
            </a>
        </div>
    </div>
    <hr class="featurette-divider">
